...
const ES: Record<string, string> = {
  ...
  "diner.here": "Estoy aquí", "diner.yourBill": "Tu cuenta", "diner.payNow": "Ir a pagar", "diner.billRequested": "Cuenta solicitada · el mesero va en camino para cobrarte.", "diner.ofTheDay": "Del día", "diner.noItems": "Este menú aún no tiene ítems.", "diner.noCatItems": "No hay ítems en esta categoría.", "diner.all": "Todo", "diner.sendOrder": "Enviar pedido", "diner.alsoLike": "También te puede gustar", "diner.noDescription": "Sin descripción.", "diner.seeMore": "ver más", "diner.seeLess": "ver menos", "diner.howWasIt": "¿Qué te pareció?", "diner.reviewPlaceholder": "Cuéntanos tu experiencia (opcional)", "diner.sendReview": "Enviar opinión", "diner.thanksReview": "¡Gracias por tu opinión!", "diner.cantOpen": "No se pudo abrir la mesa", "diner.cantOpenSub": "QR inválido", "diner.liftPhone": "Levanta el teléfono", "diner.waiterLocates": "El mesero te ubica por tu color", "diner.tapToClose": "Toca para cerrar",
